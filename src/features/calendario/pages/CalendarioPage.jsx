...
export default function CalendarioPage({ onNavigate, activeView = 'events' }) {
  ...
  const [events, setEvents] = useState([
    { 
      ...
      time: '22:00', 
      type: 'Comunidad',
      description: 'Mejor visibilidad a medianoche lejos de la contaminación lumínica de la ciudad. Se recomienda llevar telescopio o binoculares astronómicos.' 
    },
    { 
      id: 2, 
      date: '2026-07-13', 
      title: 'Conjunción Lunar', 
      time: '04:30', 
      type: 'Oficial',
      description: 'Visible a simple vista hacia el este.' 
    }
  ]);
        ...
        <div className="calendario-page-inner">
          ...
          <div className="calendar-grid-layout">
            ...
            <div className="calendar-detail-box">
              ...
              {/* Formulario de agregar evento condicionado por rol */}
              <form className="add-event-form" onSubmit={handleAddEventSubmit}>
                <h4>Añadir fecha</h4>
                <input
                  type="text"
                  placeholder={!isAuthenticated ? 'Inicia sesión para agregar fechas' : role !== 'admin' ? 'Solo administradores pueden agregar fechas' : 'Título del evento'}
                  value={draftTitle}
                ...
                <div className="form-row-inline">
                  ...
                  <button
                    type="submit"
                    className={`submit-event-btn ${role !== 'admin' ? 'locked' : ''}`}
                  >
                    {!isAuthenticated ? 'Inicia sesión' : role !== 'admin' ? 'Solo administradores' : 'Agregar'}
                  </button>
                </div>
              </form>
            </div>
