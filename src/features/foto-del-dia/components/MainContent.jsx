...
export default function MainContent({ data }) {
  const { title, imageUrl, description, date, location, credits, tags = [], stats = [] } = data || {};
      ...
      <div className="photo-view-shell">
        <section className="photo-stacked-card">
          <div className="photo-image-panel">
            ...
            {/* SE ELIMINARON LOS BOTONES/BADGES SOBREPUESTOS SOBRE LA IMAGEN */}
          </div>
          
          <div className="photo-info-panel">
            {/* SE ELIMINARON LOS BOTONES/BADGES SUPERIORES DE METADATOS */}
            <h2>{title}</h2>
            <p>{description}</p>
